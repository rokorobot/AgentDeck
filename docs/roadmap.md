...
The current shipped state (untagged v1.0.9 hardening arc on top; `main` @ `592961d`). See [`PROJECT_STATE.md`](../PROJECT_STATE.md) for the full session-reload artifact, and [`docs/audit-remediation-backlog.md`](audit-remediation-backlog.md) for the detailed audit trail behind the v1.0.8 hardening work.
